...
const page = () => {
  return (
    <main className="flex flex-col items-center justify-center ">
      <Container className="md:flex md:justify-between lg:w-full lg:justify-end md:space-x-10 lg:relative">
        <section
          className="md:w-6/12 lg:w-6/12 lg:fixed lg:top-35 left-20
